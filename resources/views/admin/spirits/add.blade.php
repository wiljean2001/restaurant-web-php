...
<div class="d-flex flex-row w-100">
    <div class="w-100">
        <h1 class="my-lg-2 mt-3 mt-lg-3">AGREGAR LICOR</h1>
        <form action=" {{ route('spirit.store') }}" method="POST" class="d-flex flex-column"
            enctype="multipart/form-data">
            @csrf
            <div class="col-md-8">
                <label for="name">Ingresar licor</label>
                <div class="form-group">
                    <input type="text" class="form-control focused w-100" placeholder="Tequila" name="name"
                        required>
                </div>
            </div>
            <div class="col-md-8">
                ...
                <div class="form-group">
                    <textarea class="form-control" placeholder="Tequila Blanco" name="description"
                        required></textarea>
                </div>
            </div>
            <div class="col-md-8">
                ...
                <div class="form-group">
                    <input type="number" class="form-control" placeholder="35.00" name="price" required step="0.01">
                </div>
            </div>
            <div class="col-md-8">
                <label for="price">Ingresar stock ud.</label>
                <div class="form-group">
                    <input type="number" class="form-control" plac  eholder="150" name="stock" required>
                </div>
            </div>
            <div class="col-md-8">
