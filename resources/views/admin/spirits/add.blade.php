    ...
    <div class="w-100">
        ...
        <form action=" {{ route('spirit.store') }}" method="POST" class="d-flex flex-column"
            ...
            <div class="col-md-8">
                ...
                <div class="form-group">
                    <textarea class="form-control" placeholder="Tequila Blanco" name="description" required></textarea>
                </div>
            </div>
            <div class="col-md-8">
            ...
            <div class="col-md-8">
                ...
                <div class="form-group">
                    <input type="number" class="form-control" placeholder="150" name="stock" required>
                </div>
            </div>
            <div class="col-md-8">
